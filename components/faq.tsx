...
export function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "You can withdraw your returns at the end of your investment period. For example, if you choose a 12-month plan, you can withdraw your principal plus returns after 12 months. Early withdrawal options are available with certain plans.",
    },
    {
