...
export function Testimonials() {
  const testimonials = [
    ...
    },
    {
      ...
      content:
        "The Premium Plan has exceeded my expectations. The 3% daily returns are real and the withdrawal process is seamless. Highly recommend for serious investors.",
      rating: 5,
    },
    {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-pretty">
            Join thousands of satisfied investors who trust us with their
            financial future
          </p>
        </div>
