            ...
            <div className="prose prose-neutral max-w-none space-y-8">
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Apex Capital ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy
                  explains how we collect, use, disclose, and safeguard your information when you use our investment
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li>Send important notices about your investments and account</li>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li>
                    <strong>Financial Institutions:</strong> Banks and payment processors for transaction processing
                  </li>
                  <li>
                    <strong>Regulatory Authorities:</strong> Government agencies as required by law
                  </li>
                  <li>
                    <strong>Legal Compliance:</strong> When necessary to comply with legal obligations or protect our
                    rights
                  </li>
                </ul>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  legal obligations. Financial records are typically retained for at least 7 years as required by law.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="bg-muted/30 p-6 rounded-lg">
                  <p className="text-foreground mb-2">
                    <strong>Apex Capital Privacy Team</strong>
                  </p>
                  <p className="text-muted-foreground">Email: privacy@apexcapital.com</p>
